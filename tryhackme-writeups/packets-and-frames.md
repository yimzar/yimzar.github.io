...
TryHackMe Room: Packets & Frames Difficulty Level: Walkthrough
...
___ - Client: Here's my Initial Sequence Number(**ISN**) to ___chronise with (0) ___/___ - Server: Here's my Initial Sequence Number (**ISN**) to ___chronise with (5,**000**), and I ___nowledge your initial number sequence (0) ___ - Client: I ___nowledge your Initial Sequence Number (**ISN**) of (5,**000**), here is some data that is my **ISN**+1 (0 + 1)"
